...
/**
 * FoodTrace Contract Verification Script
 *
 * This script verifies the deployed FoodTrace contract on Etherscan or other block explorers.
 */

const { run } = require("hardhat");

async function main() {
    console.log("\n=== FoodTrace contract verification ===\n");
    ...
    try {
        ...
        // The FoodTrace contract constructor takes no arguments
        await run("verify:verify", {
            address: contractAddress,
            constructorArguments: [], // No constructor arguments for our contract
            contract: "contracts/Traceability.sol:FoodTrace"
        });
        ...
        if (error.message.includes("Already Verified")) {
            ...
            console.error("This shouldn't happen for the FoodTrace contract as it has no constructor arguments");
        } else {
