...
/**
 * Configuration file for FoodTrace Frontend
 * 
 * Contains contract address, ABI, and other configuration constants
 */

// Contract address - UPDATE THIS AFTER DEPLOYMENT
export const CONTRACT_ADDRESS = "0xe5d918f4777e95F4021Ed1Ef5CCCBB81eeC8Adc9"; // Local Hardhat deployment
...
export const APP_CONFIG = {
  ...
  version: "2.0.0",
  description: "Blockchain-powered frozen food traceability system (Food Supply Chain)",
...
if (typeof window !== 'undefined') {
  window.FOOD_SUPPLY_CHAIN_CONFIG = {
    CONTRACT_ADDRESS,
    ABI_LENGTH: CONTRACT_ABI ? CONTRACT_ABI.length : 0
  };
  console.log('🌐 [CONFIG] Config attached to window.FOOD_SUPPLY_CHAIN_CONFIG');
}
